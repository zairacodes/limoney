        ...
        <ScrollView>
          <View style={styles.box}>
            ...
            <Text style={styles.body}>
              Congratulations {user.username}! You are the proud new owner of
              the Limoney lemonade stand!
            </Text>
            <Text style={styles.body}>
            ...
            <Text style={styles.body}>
              The bank is where to go when you want invest. Investments allow
              you to deposit some money and earn a percentage back after a
              period of time. This may take a while, and a big chunk of money,
              but will allow you to earn more in the long term.
            </Text>
            <Text style={styles.subheading}>Expenses</Text>
            <Text style={styles.body}>
              As a business owner you have some bills to pay...Rent and
              utilities allow your stand to be open and running. If you miss a
              payment then you will not be able to collect any more money, so
              remember to check in regularly and pay your bills on time!
            </Text>
